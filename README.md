...
⚙️ Bridging research → deployment with scalable systems  

## 🧑‍💻 About Me  

- 🎓 Master’s in Computer Science @ Stevens Institute Of Technology (May 2026)  
- 🤖 Specialized in LLMs, RAG systems, and ML pipelines  
- ⚡ Experienced in building end-to-end AI systems (research → production)  
...
### 🔹 Regulatory RAG System (LLM + FAISS + FastAPI)
...
### 🔹 Fraud Detection System (ML + Behavioral Biometrics)
